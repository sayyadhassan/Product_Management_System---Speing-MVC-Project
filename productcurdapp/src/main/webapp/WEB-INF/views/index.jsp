	...
	<div class="container mt-3">
		...
		<div class="row">
			...
			<div class="col-md-12">
					...
					<% int coutn = 1; %>
					  ...
					  <c:forEach items="${products }" var="p">
						<tr>
							...
							<td>${p.name }</td>
							<td>${p.description }</td>
							<td class="font-weight-bold"> &#x20B9; ${p.price }</td>  <!-- here using this code (&#x20B9) to print rupees symbol -->
							<td>
				...
				<a href="add-product" class="btn btn-outline btn-success">Add Product</a>
